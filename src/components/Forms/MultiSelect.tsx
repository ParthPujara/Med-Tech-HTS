    ...
    <div className="relative z-50">
      ...
      <div>
        <select className="hidden" id={id}>
          ...
          <option value="4">Gout</option>
          <option value="4">Diabities</option>
          <option value="4">Emotional Disorder</option>
          <option value="4">Epilepsy Seizures</option>
          <option value="4">Fanting Spells</option>
          <option value="4">Galistones</option>
          <option value="4">Heart Disease</option>
          <option value="4">Heart Attack</option>
          <option value="4">Rheumatic Fever</option>
          <option value="4">Hight Blood Pressure</option>
          <option value="4">Digestive Problems</option>
          <option value="4">Ulcer Disease</option>
          <option value="4">Hepatatis</option>
          <option value="4">Kidney Disease</option>
          <option value="4">Sleep Apnea</option>
          <option value="4">Hepatatis</option>
          <option value="4">Hepatatis</option>
        </select>
